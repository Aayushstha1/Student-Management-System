...
urlpatterns = [
    ...
    path('exam-rooms/', views.ExamRoomListCreateView.as_view(), name='exam-room-list-create'),
    path('exam-rooms/<int:pk>/', views.ExamRoomDetailView.as_view(), name='exam-room-detail'),
    path('seat-assignments/', views.ExamSeatAssignmentListView.as_view(), name='seat-assignments'),
    path('seat-plans/generate/', views.GenerateSeatPlanView.as_view(), name='seat-plan-generate'),
    path('seat-plans/clear/', views.ClearSeatPlanView.as_view(), name='seat-plan-clear'),
